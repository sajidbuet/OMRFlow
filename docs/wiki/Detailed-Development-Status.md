# Detailed Development Status and Capabilities

> **This page is the record of detail that used to make up the bulk of
> `README.md`.**
>
> When OMRFlow reached its first installable release the README became a
> concise landing page, and this material moved here rather than being
> deleted: it is the per-phase account of what was built, what was tested and
> how, written as each phase completed, and it is the most specific statement
> of OMRFlow's maturity that exists.
>
> **Where to look instead, for most purposes:**
>
> | | |
> |---|---|
> | Current phase statuses | [Development Roadmap](Development-Roadmap) |
> | What is and is not trustworthy | [Known Limitations](Known-Limitations) |
> | What has shipped | [Release History](Release-History) |
> | How to use OMRFlow | [User Guide](User-Guide) |
>
> Kept verbatim, so nothing that was true when it was written has been
> quietly reworded. Some of it predates the current interface; where it
> describes a workflow the wiki also covers, prefer the wiki.
